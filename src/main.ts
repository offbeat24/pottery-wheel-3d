...
app.innerHTML = `
  <main class="game-shell" aria-label="3D 도자기 물레 게임" data-testid="game-root" data-game-state="intro">
    ...
    <aside class="work-readout" aria-label="작업 치수">
      ...
      <div class="material-meter"><div><span>수분</span><strong id="moisture-value">82%</strong></div><div class="material-track"><i id="moisture-fill"></i></div><i id="sponge-fill" class="sponge-track"></i></div>
    </aside>
...
function updateHud(): void {
  ...
  moistureFill.classList.toggle('is-soaked', craft.moisture > 92)
